...
public class CraftingRecipes {
    ...
    private static void addRecipes() {
        ModHandler.addShapedRecipe("CarbonCasing", new ItemStack(GAGBlocks.CARBON_MACHINE_CASING), "CCC", "CwC", "CCC",
                'C', MetaItems.CARBON_FIBER_PLATE.getStackForm());

        ModHandler.addShapedRecipe("CarbonHull", new ItemStack(GAGBlocks.CARBON_MACHINE_HULL), "SES", "CHC",
                'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Gold),
                'H', new ItemStack(GAGBlocks.CARBON_MACHINE_CASING),
                'S', new ItemStack(GCItems.basicItem, 1, 9),
                'E', new UnificationEntry(OrePrefix.plate, GAGMaterials.Enori));
    }
