...
public class MEOutputBus extends MetaTileEntityAEHostablePart<IAEItemStack>
    ...
    public MEOutputBus(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTValues.IV, true, IItemStorageChannel.class);
    }
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MEOutputBus(this.metaTileEntityId);
    }
    ...
    public void registerAbilities(List<IItemHandlerModifiable> abilityList) {
        abilityList.add(new MEOutputBus.InaccessibleInfiniteSlot(this, this.internalBuffer, this.getController()));
    }
