...
public class MEOutputHatch extends MetaTileEntityAEHostablePart<IAEFluidStack>
    ...
    public MEOutputHatch(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTValues.IV, true, IFluidStorageChannel.class);
    }
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MEOutputHatch(this.metaTileEntityId);
    }
