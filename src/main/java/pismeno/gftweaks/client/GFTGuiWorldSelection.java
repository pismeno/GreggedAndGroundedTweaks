...
public class GFTGuiWorldSelection extends GuiWorldSelection {
    public GFTGuiWorldSelection(GuiScreen parentScreen) {
        super(parentScreen);
    }
    ...
    public static void init(GuiOpenEvent event) {
        ...
        if (gui instanceof OTGGuiWorldSelection) {
            event.setGui(new GFTGuiWorldSelection(new GuiMainMenu()));
        }
    }
}
